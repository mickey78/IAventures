...
import { ScrollText, Rocket, Anchor, Sun, Search, Sparkles, Heart, Gamepad2, ShieldAlert, Castle, Drama } from 'lucide-react'; // Added Castle and Drama icons
import type { Theme } from '@/types/game'; // Import shared type

export const themes: Theme[] = [
  {
    value: 'Fantasy Médiévale', label: 'Fantasy Médiévale', description: 'Explorez des châteaux, combattez des dragons et découvrez des trésors.', icon: Castle, // Changed icon
    subThemes: [
      ...
      { value: 'Tournoi Chevalier', label: 'Le Grand Tournoi du Royaume', prompt: 'Tu participes au grand tournoi de chevalerie du royaume. Prépare-toi pour les joutes, les mêlées et peut-être une intrigue à déjouer dans les coulisses.' },
      { value: 'Dragon Apprivoisé', label: 'L\'Œuf de Dragon', prompt: 'Tu découvres un œuf de dragon abandonné dans une grotte secrète. Décideras-tu de le protéger et d\'essayer d\'élever un jeune dragon, ou de le rapporter au roi ?' },
      { value: 'Forêt Enchantée', label: 'Le Secret de la Forêt Murmurante', prompt: 'La forêt près de ton village est devenue étrangement silencieuse. Les animaux ont disparu et des lueurs étranges apparaissent la nuit. Tu pars enquêter sur ce mystère.' },
    ]
  },
  {
    ...
    subThemes: [
      ...
      { value: 'Chasseur Prime', label: 'Le Contrat du Chasseur de Primes', prompt: 'Tu es un jeune chasseur de primes et tu viens d\'accepter un contrat pour retrouver un vaisseau volé. Ta cible se cache dans une ceinture d\'astéroïdes dangereuse.' },
      { value: 'Planète Océan', label: 'Les Profondeurs de Xylos', prompt: 'Ta mission est d\'explorer les océans violets de la planète Xylos à bord d\'un mini-sous-marin. Que découvriras-tu sous les vagues scintillantes ?' },
      { value: 'Anomalie Temporelle', label: 'Le Trou de Ver Instable', prompt: 'Ton vaisseau est aspiré par une anomalie spatio-temporelle ! Tu te retrouves dans un secteur inconnu de la galaxie, peut-être même à une autre époque.' },
    ]
  },
  {
    ...
    subThemes: [
      ...
      { value: 'Vaisseau Fantôme', label: 'La Légende du Hollandais Volant', prompt: 'Par une nuit sans lune, tu aperçois le légendaire vaisseau fantôme, le Hollandais Volant. Oseras-tu l\'aborder pour découvrir ses secrets ?' },
      { value: 'Sirène Mystérieuse', label: 'Le Chant de la Sirène', prompt: 'Tu entends un chant mélodieux venant d\'un récif isolé. Les marins disent que c\'est une sirène. Est-ce un piège ou un appel à l\'aide ?' },
      { value: 'Contrebandiers', label: 'La Crique des Contrebandiers', prompt: 'Tu découvres une crique secrète utilisée par des contrebandiers. Tu peux essayer de les rejoindre, de voler leur butin, ou de les dénoncer aux autorités.' },
    ]
  },
  {
    ...
    subThemes: [
      ...
      { value: 'Troupeau Perdu', label: 'La Ruée vers le Nord', prompt: 'Tu dois aider un vieux fermier à conduire son troupeau de bétail à travers des plaines dangereuses jusqu\'à la ville la plus proche, en évitant les voleurs et les coyotes.' },
      { value: 'Train Postal', label: 'Le Vol du Train Postal', prompt: 'Tu es à bord du train postal quand il est attaqué par des hors-la-loi. Choisiras-tu de les affronter ou de te cacher avec les autres passagers ?' },
      { value: 'Mine d\'Or', label: 'La Fièvre de l\'Or', prompt: 'Tu découvres une carte indiquant l\'emplacement d\'une mine d\'or oubliée dans les montagnes. Mais d\'autres chercheurs d\'or sont aussi sur la piste...' },
    ]
  },
  {
    ...
    subThemes: [
      ...
      { value: 'Cirque Etrange', label: 'Le Mystère du Cirque Itinérant', prompt: 'Un cirque étrange arrive en ville. Peu après, des objets disparaissent mystérieusement. Tu décides d\'infiltrer le cirque pour enquêter.' },
      { value: 'Chien Disparu', label: 'Où est Passé Patapouf ?', prompt: 'Le chien adoré de ta voisine a disparu ! Tu suis ses traces pour le retrouver, découvrant des indices surprenants en chemin.' },
      { value: 'Sabotage Scolaire', label: 'Sabotage à l\'École', prompt: 'Quelqu\'un sabote les expériences scientifiques de l\'école avant le grand concours. Tu dois découvrir qui est le coupable avant qu\'il ne soit trop tard.' },
    ]
  },
  {
    ...
    subThemes: [
      ...
      { value: 'Voyage Temporel', label: 'Erreur Temporelle', prompt: 'Lors d\'une expérience, tu actives accidentellement une machine à voyager dans le temps et te retrouves coincé(e) dans le passé (ou le futur !). Comment vas-tu rentrer ?' },
      { value: 'Animal de Compagnie', label: 'Un Animal de Compagnie Pas Comme les Autres', prompt: 'Tu trouves un animal étrange avec des pouvoirs surprenants. Tu décides de le garder secret, mais il attire bientôt l\'attention d\'une organisation mystérieuse.' },
      { value: 'Compétition Inter-écoles', label: 'Le Défi des Héros', prompt: 'Ton école participe à une compétition amicale contre une autre académie de super-héros. Mais quelqu\'un semble tricher pour gagner...' },
    ]
  },
   {
     value: 'Histoire d\'Amour', label: 'Histoire d\'Amour', description: 'Vivez une romance, rencontrez l\'âme sœur et surmontez les obstacles.', icon: Drama, // Changed Icon
     subThemes: [
       ...
       { value: 'Voyage Scolaire', label: 'Amour en Voyage Scolaire', prompt: 'Lors d\'un voyage scolaire dans une ville romantique (comme Paris ou Venise), tu te rapproches de quelqu\'un de spécial, mais un malentendu menace votre relation naissante.' },
       { value: 'Rivalité Amoureuse', label: 'Deux Prétendants', prompt: 'Deux personnes sympathiques semblent intéressées par toi. Comment vas-tu gérer cette situation délicate sans blesser personne ?' },
       { value: 'Amis d\'Enfance', label: 'Plus que des Amis ?', prompt: 'Tu réalises que tu as des sentiments pour ton/ta meilleur(e) ami(e) d\'enfance. Vas-tu lui avouer ou garder le secret pour préserver votre amitié ?' },
     ]
   },
   {
     ...
     subThemes: [
       ...
       { value: 'Quête Principale', label: 'La Quête du Dernier Boss', prompt: 'Pour sortir du jeu, on dit qu\'il faut vaincre le dernier boss légendaire. Tu te lances dans cette quête épique, rencontrant d\'autres joueurs piégés en chemin.' },
       { value: 'Mode Difficile', label: 'Mode Survie Activé', prompt: 'Tu te retrouves dans une version "hardcore" du jeu où les ressources sont rares et les monstres plus forts. La coopération avec d\'autres joueurs est essentielle.' },
       { value: 'Code Source', label: 'Accès au Code Source', prompt: 'Tu découvres un moyen d\'accéder au code source du jeu. Peux-tu l\'utiliser pour tricher, aider les autres, ou trouver la sortie ? Attention aux administrateurs !' },
     ]
   },
  {
